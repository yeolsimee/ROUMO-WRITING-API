...
public class AmazonS3Service {
	 ...
	 * S3로 파일 업로드
	 */
	public UploadFile uploadFile(String fileType, MultipartFile multipartFile) {
		...
		UploadFile UploadFile = new UploadFile(originalFileName, uploadFileName, uploadFilePath, uploadFileUrl);
